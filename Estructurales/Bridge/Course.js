...
class Course {
    ...
    clone() {
        return new Course(this.name, this.description, [...this.materials], Object.assign({}, this.instructorDetails), this.schedule ? Object.assign({}, this.schedule) : null, this.students ? this.students.map(student => (Object.assign({}, student))) : null, this.startDate, this.endDate);
    }
    displayCourseInfo() {
        var _a, _b, _c, _d, _e;
